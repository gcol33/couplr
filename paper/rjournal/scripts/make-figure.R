...
# mu via plotmath rather than a literal U+00B5: the symbol font is always
# present, so the label survives devices whose text font lacks the glyph.
y_lbls   <- expression("10 " * mu * "s", "1 ms", "100 ms", "10 s")
x_dom    <- c(4, 5000)
