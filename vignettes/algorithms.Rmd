...
ggplot(race_data, aes(x = reorder(algorithm, -time_ms), y = time_ms, fill = algorithm)) +
  ...
  geom_text(aes(label = paste0(time_ms, " ms")),
            hjust = -0.1, size = 5, fontface = "bold", colour = "#3E3F3A") +
  geom_text(aes(label = paste0("(", year, ")")),
            hjust = -0.1, vjust = 2.5, size = 3.5, colour = "#3E3F3A") +
  ...
  theme(
    ...
    axis.text.y = element_text(size = 12, face = "bold", colour = "#3E3F3A"),
    axis.text.x = element_text(size = 10, colour = "#3E3F3A"),
    axis.title = element_text(colour = "#3E3F3A"),
