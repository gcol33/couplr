...
algorithms. Provides modern, tidy implementations of 'Hungarian',
'Jonker-Volgenant', 'Auction', and other LAP solvers. Designed for
...
match quality using standardized differences and distribution
comparisons.
...
**Maintainer**: Gilles Colling <gilles.colling051@gmail.com> \[copyright
holder\]
