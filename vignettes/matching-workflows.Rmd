...
The **critical gamma** ($\Gamma$) is the smallest value at which the upper-bound p-value crosses 0.05. A critical gamma of 2.0, for example, means an unobserved confounder would need to change the odds of treatment by a factor of 2 to explain away the result.
...
- `?ps_match`, `?cardinality_match`, `?sensitivity_analysis`
