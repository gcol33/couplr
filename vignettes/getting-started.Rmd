...
couplr solves the Linear Assignment Problem (LAP): given a cost matrix where entry (i, j) represents the cost of assigning source i to target j, find the one-to-one assignment that minimizes total cost. It also provides production-ready matching workflows for observational studies.
...
| [Algorithms](algorithms.html) | Mathematical foundations, solver selection | Technical users | 30 min |
| [Matching Workflows](matching-workflows.html) | Production matching pipelines | Researchers | 45 min |
| [Comparison](comparison.html) | vs MatchIt, optmatch, designmatch | Package evaluators | 20 min |
| [Troubleshooting](troubleshooting.html) | Common issues and solutions | All users | As needed |
| [Pixel Morphing](pixel-morphing.html) | Scientific applications | Advanced | 30 min |
