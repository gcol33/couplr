...
minimum-cost flow problem is established [@HansenKlopfer2006]; here it is the
one design whose flow value is not fixed in advance, since how many pair arcs a
