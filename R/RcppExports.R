...
oa_test_reduced_cost <- function(cost_r, i, j, row_price_r, col_price_r) {
    .Call(`_couplr_oa_test_reduced_cost`, cost_r, i, j, row_price_r, col_price_r)
}

oa_test_all_reduced_costs <- function(cost_r, row_price_r, col_price_r) {
    .Call(`_couplr_oa_test_all_reduced_costs`, cost_r, row_price_r, col_price_r)
}

oa_test_epsilon_cs <- function(cost_r, row_to_col_r, row_price_r, col_price_r, epsilon) {
    .Call(`_couplr_oa_test_epsilon_cs`, cost_r, row_to_col_r, row_price_r, col_price_r, epsilon)
}

oa_test_find_best_columns <- function(cost_r, row, col_price_r) {
    .Call(`_couplr_oa_test_find_best_columns`, cost_r, row, col_price_r)
}

oa_test_single_bid <- function(cost_r, row, row_to_col_r, row_price_r, col_price_r, epsilon) {
    .Call(`_couplr_oa_test_single_bid`, cost_r, row, row_to_col_r, row_price_r, col_price_r, epsilon)
}

oa_test_auction_round <- function(cost_r, row_to_col_r, row_price_r, col_price_r, epsilon) {
    .Call(`_couplr_oa_test_auction_round`, cost_r, row_to_col_r, row_price_r, col_price_r, epsilon)
}

oa_complexity_reduced_costs <- function(sizes, reps = 5L) {
    .Call(`_couplr_oa_complexity_reduced_costs`, sizes, reps)
}

oa_complexity_auction_round <- function(sizes, reps = 3L) {
    .Call(`_couplr_oa_complexity_auction_round`, sizes, reps)
}

oa_test_dijkstra <- function(cost_r, row_to_col_r, row_price_r, col_price_r) {
    .Call(`_couplr_oa_test_dijkstra`, cost_r, row_to_col_r, row_price_r, col_price_r)
}

oa_test_ssp_phase <- function(cost_r, row_to_col_r, row_price_r, col_price_r) {
    .Call(`_couplr_oa_test_ssp_phase`, cost_r, row_to_col_r, row_price_r, col_price_r)
}

oa_test_scale_count <- function(max_cost, n, alpha = 5.0) {
    .Call(`_couplr_oa_test_scale_count`, max_cost, n, alpha)
}
...
oa_complexity_augmentations_per_scale <- function(sizes, reps = 3L) {
    .Call(`_couplr_oa_complexity_augmentations_per_scale`, sizes, reps)
}
