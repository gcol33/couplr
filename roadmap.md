...
| 1 | 2 | A: certification layer, real status values, `verify_assignment()`, LEMON oracle, `explain_dispatch()` (#28) | next |
| 2 | 3-4 | B: flow model, design compiler, node potentials from the flow solver | |
