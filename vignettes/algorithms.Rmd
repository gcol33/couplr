...
edges <- data.frame(
  from_x = c(4, 4, 7, 7, 7, 7),
  from_y = c(4, 4, 3, 3, 2, 2),
  to_x = c(1.5, 7, 4, 7, 5.5, 8.5),
  to_y = c(3, 3, 2, 2, 1, 1),
  label = c("Yes", "No", "Yes", "No", "Yes", "No"),
  label_x = c(2.5, 5.7, 5.2, 7.3, 6.0, 8.0),
...
ggplot() +
  ...
  coord_cartesian(xlim = c(0.5, 9.5), ylim = c(0.5, 4.5))
```
...
ggplot() +
  ...
  annotate("text", x = 0, y = 0.3, label = "S (supply=n)", size = 4, color = "#6c757d") +
  annotate("text", x = 1.5, y = 0.3, label = "Rows", size = 4, color = "#f47c3c") +
  annotate("text", x = 3.5, y = 0.3, label = "Columns", size = 4, color = "#29abe0") +
  annotate("text", x = 5, y = 0.3, label = "T (demand=n)", size = 4, color = "#6c757d") +
