...
// This will be linked from solve_csflow_pure.cpp when available
...
LapResult solve_hk01(const CostMatrix& cost, bool maximize) {
    ...
    if (pal.all_equal) {
        ...
        if (mm == n) {
            ...
            // For now, throw error since we don't have solve_csflow_pure yet
